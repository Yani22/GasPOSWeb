"""
Django settings for GasPOS project.
...
SECRET_KEY = 'django-insecure-ofxlrftm+1n5yuje_i#ri@l4-y9wz6y3d=9a)#!5$c!c^j3w*-'
...
WSGI_APPLICATION = 'GasPOS.wsgi.application'
